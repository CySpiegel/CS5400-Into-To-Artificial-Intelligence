...
# Astar search
def astar(Board, Direction_Order, Goal, spawnFrequencyWeighting, SpawnPool, algoSelection):
        ...
        if (GraphVisited.get(key)):
            ...
            for i in range(len(Direction_Order)):
                    ...
                    if (moveSuccessful):
                        ...
                        heapq.heappush(Q, (temp.heuristic(spawnFrequencyWeighting, SpawnPool, Goal, algoSelection), temp))
