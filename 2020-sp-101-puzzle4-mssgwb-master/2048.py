...
if __name__ == "__main__":
    ...
    StartingBoard = GameBoard(gridBoard, Width, Height, SpawnPool, "", ScoreGoal, ScoreGoal)



    # # Main program Driver and AI
    start_time = datetime.now()
    Final_Board = astar(StartingBoard, DIRECTION, ScoreGoal, spawnFrequencyWeighting, SpawnPool, algoSelection)
