...
# does not return anything, it prints the board to the screen
...
# Paramaters:
# FenBoardList: Fen Board portion of the fen string
# returns new chess board as list of list
...
# Paramaters
# UCIString: action in UCI format
# returns tuple of converted UCIFormat move to grid pos and next grid pos
...
# paramaters:
# Color: player color
# ChessBoard: current chess board as list of list
...
# paramaters
# ChessBoard: current chess board as list of list
# Enemy: color of enemy player
# Row: row possition of knight
# Col: colimn position of knight
...
# Paramaters:
# ChessBoard: current chess board as list of list
# MyChessPeaces: Players side of chess peaces format R or r
# Enemy: players enemy faction color
# isKing: is the current selected peace a king, if so limit to king move distance
# Row: row position of peace
# Col: column popsition of peave
# returns list of diagonal moves from a pos in UCI format
...
# MyChessPeaces: Players side of chess peaces format R or r
# Enemy: players enemy faction color
# kingRow: row position of king
# kingCol: column popsition of king
...
# MyChessPeaces: Players side of chess peaces format R or r
# Enemy: players enemy faction color
# kingRow: row position of king peace
# kingCol: column popsition of king peave
