...
from games.chess.tliddlmmabhtqs import *
import random
...
class AI(BaseAI):
    ...
    def make_move(self) -> str:
        ...
        Time_In_Seconds = self.player.time_remaining / (10**9)
        # movementList = generateSelectedPeaceMoveList(self.player.color, newChessBoard, False)
        movePair = tliddlmmabhtqs(newChessBoard, self.player.color, Time_In_Seconds, self.game.history)
