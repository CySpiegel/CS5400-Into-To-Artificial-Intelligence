...
class AI(BaseAI):
    ...
    def start(self) -> None:
        ...
        # <<-- /Creer-Merge: start -->>
                #parsing fen string into something usable
    ...
    def make_move(self) -> str:
        ...
        # Creating 2d matrix for chess board
        ...
        randomPeace = random.randint(0, len(movementList) - 1)
        print("")
        print(movementList[randomPeace])
        randomMmove = random.choice(movementList[randomPeace])
